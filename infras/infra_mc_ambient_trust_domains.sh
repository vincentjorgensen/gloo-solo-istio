...
export TRUST_DOMAIN=cluster3.local

export GSI_REMOTE_CLUSTER=cluster4
export GSI_REMOTE_CONTEXT=cluster4
export GSI_REMOTE_NETWORK=cluster4
export REMOTE_TRUST_DOMAIN=cluster4.local
