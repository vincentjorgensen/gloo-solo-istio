...
function deck_ambient_gloo_gateway_v2 {
  export GSI_CLUSTER=$1
  export GSI_CONTEXT=$1
  export GSI_NETWORK=$1
...
function deck_ambient_gloo_gateway_v2_cert_manager_keycloak {
  export GSI_CLUSTER=$1
  export GSI_CONTEXT=$1
  export GSI_NETWORK=$1
  ...
  export GSI_DECK=(
    ...
    exec_extauth_keycloak_ggv2_auth_config
